...
live_users_live_str = str(live_users_live['users_live'].tail(2).values[0])
...
live_users_busy_int = int(live_users_busy['users_busy_live'].tail(2).values[0])
...
last_rows = fifteen_overall.sort_index(ascending=False)
